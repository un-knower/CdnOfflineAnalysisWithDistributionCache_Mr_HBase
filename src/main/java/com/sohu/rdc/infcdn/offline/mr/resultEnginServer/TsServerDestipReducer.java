 ...
 *
 */
public class TsServerDestipReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {

    private static final Logger LOG = LoggerFactory.getLogger(TsServerDestipReducer.class);
    ...
    public void reduce(Text key, Iterable<Text> values, Context context)
        ...
        for (Text value : values) {
            ...
            int pointOfDay = dt.getHourOfDay() * 12 + dt.getMinuteOfHour() + 1;
