package com.sohu.rdc.infcdn.offline.mr.comOfServerDestIp;
 ...
 */
public class ServerDestIpJob {

    private static final Logger LOG = LoggerFactory.getLogger(ServerDestIpJob.class);
...
//        conf.addResource(new Path("file:///etc/hbase/conf/hbase-site.xml"));
        ...
        job.setJarByClass(ServerDestIpJob.class);
        job.setMapperClass(ServerDestIpMapper.class);

        job.setReducerClass(ServerDestIpReducer.class);
        job.setCombinerClass(ServerDestIpReducer.class);
