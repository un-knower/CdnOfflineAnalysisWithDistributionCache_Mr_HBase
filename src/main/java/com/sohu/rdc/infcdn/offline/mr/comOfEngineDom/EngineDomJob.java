package com.sohu.rdc.infcdn.offline.mr.comOfEngineDom;
 ...
 */
public class EngineDomJob {

    private static final Logger LOG = LoggerFactory.getLogger(EngineDomJob.class);
...
//        conf.addResource(new Path("file:///etc/hbase/conf/hbase-site.xml"));
        ...
        job.setJarByClass(EngineDomJob.class);
        job.setMapperClass(EngineDomMapper.class);

        job.setReducerClass(EngineDomReducer.class);
        job.setCombinerClass(EngineDomReducer.class);
