package com.sohu.rdc.infcdn.offline.mr.comOfDomain;
...
public class DomainJob {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(DomainJob.class);
